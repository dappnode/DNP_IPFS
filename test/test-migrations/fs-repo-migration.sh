...
# 0. Set-up
echo echo -e "\e[32m [INFO] Creating dncore_network if needed...\e[0m"
...
echo echo -e "\e[32m [INFO] Build old ipfs ${IPFS_OLD}\e[0m"
...
echo echo -e "\e[32m [INFO] Build new ipfs ${IPFS_NEW}\e[0m"
docker-compose build --build-arg UPSTREAM_VERSION=${IPFS_NEW}
docker-compose -f docker-compose.yml up -d
sleep 10

echo echo -e "\e[32m [INFO] Check logs for migration\e[0m"
